...
{
    public class ResourceSensorModelBinder : IModelBinder
    {
        ResourceModelBinderHelper<Sensor, CommonTypes.SensorType> _helper;
        private readonly ISensorTypeRepository _sensorTypeRepository;
        private readonly ISiteRepository _siteRepository;

        public ResourceSensorModelBinder(
            ISensorTypeRepository sensorTypeRepository,
            ISiteRepository siteRepository)
        {
            _helper = new ResourceModelBinderHelper<Sensor, CommonTypes.SensorType>();
